...
void setup() {
  ...
  // Attach servos with extended pulse range for better movement
  servo1.attach(SERVO_1, 500, 2500);  // Extended pulse range
  servo2.attach(SERVO_2, 500, 2500);  // Extended pulse range
  
  // Move servos to rest position with delay to ensure they reach position
...
void loop() {
  ...
  // PATH 1: If metal detected AND servo hasn't moved yet
